{ lib, cfg, ... }:
{
  ...
  extensionsList = {
    "uBlock0@raymondhill.net" = lib.mkIf (lib.elem "ublock" cfg.addons) {
      install_url = "https://addons.mozilla.org/firefox/downloads/file/4940584/ublock_origin-1.73.0.xpi";
    };
    "jid1-MnnxcxisBPnSXQ@jetpack" = lib.mkIf (lib.elem "privacy-badger" cfg.addons) {
      install_url = "https://addons.mozilla.org/firefox/downloads/file/4944345/privacy_badger17-2026.8.7.xpi";
    };
